...
def test_seed_reproducibility_file():
    dataset_name = "imdb"
    ...
    for i, example in enumerate(train_dataset):
        ...
        mod1 = ItemInjection.from_list(country_list, token_proportion=0.5, location="random", seed=123)
        mod2 = ItemInjection.from_list(country_list, token_proportion=0.5, location="random", seed=123)
        mod3 = ItemInjection.from_file("spurious_corr/data/countries.txt", token_proportion=0.5, location="random", seed=123)
        mod4 = ItemInjection.from_file("spurious_corr/data/countries.txt", token_proportion=0.5, location="random", seed=123)
...
def test_seed_reproducibility_function():
    dataset_name = "imdb"
    data = llm_research.data.from_name(dataset_name)
    train_dataset, test_dataset = data["train"], data["test"]
...
#     text = "test seed reproducibility"
#     mod1 = ItemInjection.from_list(["<S>"], token_proportion=0.5, location="random", seed=123)
#     mod2 = ItemInjection.from_list(["<S>"], token_proportion=0.5, location="random", seed=123)
